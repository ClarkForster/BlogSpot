...
![gemm_float_baseline+cublas.png](sgemm-assets/gemm_float_baseline+cublas.png)
...
![image.png](sgemm-assets/image.png)
...
![image.png](sgemm-assets/image%201.png)
...
![baseline+coalesce.png](sgemm-assets/baseline+coalesce.png)
...
![image.png](sgemm-assets/image%202.png)

### 性能结果图

![baseline+smem.png](sgemm-assets/baseline+smem.png)
...
![image.png](sgemm-assets/image%203.png)

### 性能结果图

![baseline+blocktiling.png](sgemm-assets/baseline+blocktiling.png)
...
![image.png](sgemm-assets/image%204.png)
...
![baseline+blocktiling_2d.png](sgemm-assets/baseline+blocktiling_2d.png)
...
![baseline+vectorize.png](sgemm-assets/baseline+vectorize.png)
...
![image.png](sgemm-assets/image%205.png)
...
![baseline+SimpleBuffering.png](sgemm-assets/baseline+SimpleBuffering.png)
...
![buffering.png](sgemm-assets/buffering.png)
...
![PTX_4090_architecture.png](sgemm-assets/PTX_4090_architecture.png)
...
![image.png](sgemm-assets/image%206.png)
