---
layout: doc
title: C语言储存精度与类型转换问题
date: 2026-04-08
category: C语言
description: 围绕浮点数储存方式与变量自动转换规则，记录一次从初学者问题出发展开的 C 语言类型系统学习笔记。
tags: [C语言, 浮点数, 类型转换, 编译器, 数据表示]
featured: false
---
...
![image.png](Photos/c-language-storage-precision-and-type-conversion-issues/image.png)
...
![image.png](Photos/c-language-storage-precision-and-type-conversion-issues/image%201.png)
...
![image.png](Photos/c-language-storage-precision-and-type-conversion-issues/image%202.png)
